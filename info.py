...
PICS = (environ.get('PICS', 'https://telegra.ph/file/31bcbd9ae48f7566624da.jpg https://telegra.ph/file/641932f5fe35bd276b6ff.jpg ')).split() #SAMPLE PIC
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6970859316').split()]
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/filmytak_official/15')
